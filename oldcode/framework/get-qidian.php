...
$url='http://all.qidian.com/book/bookStore.aspx?ChannelId=12&SubCategoryId=-1&Tag=all&Size=-1&Action=-1&OrderId=6&P=all&PageIndex='.$index.'&update=-1&Vip=-1&Boutique=-1&SignStatus=-1';
...
if ($k+1<=$max)
echo' <meta http-equiv ="refresh" content = "1;http://127.0.0.1:8099/framework-1/get-qidian.php?k='.($k+1).'">';

 ?>
 </head>
 <body>
<a href="http://127.0.0.1:8099/framework-1/get-qidian.php?k=<?php echo ($k+1);?>">next</a>k=<?php echo ($k+1);?>
<div>
